...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_voi_ostaa_kun_saldoa_edullisen_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
	#Kortilla on nyt saldoa 10-2.5-2.5-2.5=2.5 euroa
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_maukkaan_lounaan_voi_ostaa_kun_saldoa_maukkaan_verran(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.lataa_rahaa(2)
        #Kortilla on nyt saldoa 4 euroa
        self.kortti.syo_maukkaasti()
